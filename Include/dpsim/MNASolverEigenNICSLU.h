...
namespace DPsim {
	...
	class MnaSolverEigenNICSLU : public MnaSolver<VarType> {
	protected:
		...
		std::unordered_map< std::bitset<SWITCH_NUM>, std::vector< std::shared_ptr< CPS::LUFactorizedNICSLU> > > mLuFactorizations;
		...
		CPS::LUFactorizedNICSLU mLuFactorizationVariableSystemMatrix;
	...
	public:
		...
		MnaSolverEigenNICSLU(String name,
			CPS::Domain domain = CPS::Domain::DP,
			CPS::Logger::Level logLevel = CPS::Logger::Level::info);

		/// Destructor
		virtual ~MnaSolverEigenNICSLU() { };
		...
		public:
			...
			SolveTask(MnaSolverEigenNICSLU<VarType>& solver) :
		...
		private:
			MnaSolverEigenNICSLU<VarType>& mSolver;
		};

		///
		class SolveTaskHarm : public CPS::Task {
		public:
			SolveTaskHarm(MnaSolverEigenNICSLU<VarType>& solver, UInt freqIdx) :
		...
		public:
			...
			SolveTaskRecomp(MnaSolverEigenNICSLU<VarType>& solver) :
				Task(solver.mName + ".Solve"), mSolver(solver) {
		...
		public:
			LogTask(MnaSolverEigenNICSLU<VarType>& solver) :
