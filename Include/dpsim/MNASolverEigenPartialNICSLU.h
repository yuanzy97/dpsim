...
namespace DPsim {
	...
	class MnaSolverEigenPartialNICSLU : public MnaSolverEigenNICSLU<VarType> {
		protected:
		...
		public:
		MnaSolverEigenPartialNICSLU(String name,
			CPS::Domain domain = CPS::Domain::DP,
			CPS::Logger::Level logLevel = CPS::Logger::Level::info);

		/// Destructor
		virtual ~MnaSolverEigenPartialNICSLU() { };
		...
		public:
			...
			SolveTaskRecomp(MnaSolverEigenPartialNICSLU<VarType>& solver) :
		...
		private:
			MnaSolverEigenPartialNICSLU<VarType>& mSolver;
		};
	};
}